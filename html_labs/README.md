...
Open [index.html](index.html) in a browser. It links all 28 labs in the recommended course sequence. Displayed lab numbers follow this sequence; source-folder numbers remain stable identifiers.
