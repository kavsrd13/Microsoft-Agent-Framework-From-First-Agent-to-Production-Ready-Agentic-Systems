...
agent_name = "travel-policy-identity-agent"
...
settings = {
    ...
    "AZURE_STORAGE_BLOB_NAME": os.environ["AZURE_STORAGE_BLOB_NAME"],
}
...
with AzureCliCredential() as credential, AIProjectClient(
    ...
    print("Grant this agent's identity Storage Blob Data Reader before invoking.")
